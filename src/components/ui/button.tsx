  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 glass-button",
        ghost: "hover:bg-accent hover:text-accent-foreground glass-button",
        link: "text-primary underline-offset-4 hover:underline",
        glass: "glass-button backdrop-blur-md border border-white/20 shadow-lg hover:shadow-xl transform hover:scale-105",
